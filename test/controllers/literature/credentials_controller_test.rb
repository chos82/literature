...
module Literature
  class CredentialsControllerTest < ActionController::TestCase
    setup do
      @credential = literature_credentials(:one)
    ...
    test "should create credential" do
      assert_difference('Credential.count') do
        post :create, credential: { token: @credential.token, user_id: @credential.user_id }
      end
    ...
    test "should update credential" do
      patch :update, id: @credential, credential: { token: @credential.token, user_id: @credential.user_id }
      assert_redirected_to credential_path(assigns(:credential))
    end
